...
export default function Page() {
  ...
  return (
    <div className="z-[-1] w-full h-full flex flex-col space-y-4 sm:gap-4 sm:space-y-0 sm:grid sm:grid-cols-2 xl:grid-cols-3 sm:grid-rows-2 p-4">
      <div className="relative w-full h-full">
        <div className="w-full h-full bg-zinc-800 rounded-2xl p-8 flex flex-col items-center justify-end">
          ...
          <div className="w-full flex flex-col space-y-3 py-6">
            <CloudDrizzle size={width > 640 ? 100 : 64} color="#d1d1d1" />
            <div className="text-[#d1d1d1] flex">
              <p className="text-6xl sm:text-7xl">28</p>
              <p className="text-2xl sm:text-3xl">°C</p>
            </div>
            <div className="flex space-x-2 items-center">
              <CloudHail color="#d1d1d1" size={32} />
              <p className="text-[#d1d1d1] text-sm sm:text-lg">Rainy Storm Clouds</p>
            </div>
          </div>
          <div className="w-full flex flex-col space-y-3 border-t-[1px] border-t-[#d1d1d1] py-6">
            <div className="flex space-x-2 items-center">
              <MapPin size={18} color="#d1d1d1" />
              <p className="text-[#d1d1d1] text-sm">Florida, US</p>
            </div>
            <div className="flex space-x-2 items-center">
              <CalendarDays color="#d1d1d1" size={18} />
              <p className="text-[#d1d1d1] text-sm">24 July, 2022</p>
              <p className="text-[#d1d1d1] text-sm font-bold">5:01 AM</p>
            </div>
          </div>
        </div>
      </div>
